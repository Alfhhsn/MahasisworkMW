...
<html lang="en">
  ...
  <body>
    ...
    <section class="dashboard">
      <div class="container-fluid">
        <div class="row">
          <div class="col left">
            <div class="card user">
              <div class="card-body card-comp">
                <h5 class="card-title">Halo User!</h5>
                <a href="#" class="card-link">Mulai jasa sekarang!</a>
              </div>
            </div>
            <div class="col right">
              <div class="card">
    ...
    <section class="rekomendasi">
      <div class="container-fluid">
        <h1 class="title">Rekomendasi untuk kamu</h1>
        <div class="row">
          <div class="col-4">
    ...
    <section class="best">
      <div class="container-fluid">
        <h1 class="title">Teratas dalam Design Graphic</h1>
        <div class="row">
          <div class="col-4">
            <div class="card text-bg-transparent bg-transparent">
              <img src="img/ningning.png" class="card-img" alt="">
